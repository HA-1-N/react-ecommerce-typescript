...
const Products = ({ cat, filters, sort }: any) => {
    ...
    useEffect(() => {
        if (sort === "newest") {
            setFilteredProducts((prev: any) => [...prev]?.sort((a: any, b: any) => a.createdAt - b.createdAt));
        } else if (sort === "asc") {
            setFilteredProducts((prev: any) => [...prev]?.sort((a: any, b: any) => a.price - b.price));
        } else {
            setFilteredProducts((prev: any) => [...prev]?.sort((a: any, b: any) => b.price - a.price));
        }
    }, [sort]);
